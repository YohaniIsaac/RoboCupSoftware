...
# *********************************************************************************************************************
    ...
    def update_obstacle(self, n_list_obs, start_new):
        ...
        diferencia_rect = self.comparar_listas(self.obs_rectangle, Env.obs_rectangle_met(n_list_obs))
        diferencia_circ = self.comparar_listas(self.obs_circle, Env.obs_circle_met(n_list_obs))
