...
def calculate_ball_approach_position(player_pos, ball_pos, opponent_goal_pos, approach_distance=50, team='red'):
    """
    ...
    if ideal_distance > 200:  # Robot muy lejos del punto ideal
        ...
        if player_to_ball_distance > 1:
            ...
            target_pos = (compromise_factor * ideal_position +
...
def calculate_interception_position(player_pos, ball_pos, ball_velocity, opponent_goal_pos, team='red',
                                    prediction_time=1.0, approach_distance=40):
    """
...
def calculate_shooting_position(player_pos, ball_pos, target_goal, approach_distance=60):
    """
...
def get_optimal_ball_approach_strategy(blackboard):
    ...
    if blackboard.zona_pelota < 0.4:  # Zona defensiva
        return 'defensive'
    elif blackboard.zona_pelota > 1.6:  # Zona ofensiva
        return 'offensive'
    else:  # Zona neutral
...
def calculate_dribbling_path_positions(ball_pos, target_goal, num_waypoints=3, spacing=100):
    """
